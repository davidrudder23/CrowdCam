...
import static org.noses.crowdcam.MainActivity.RTMP_BASE_URL;
...
public class LiveVideoBroadcasterActivity extends AppCompatActivity {
    ...
    public void toggleBroadcasting(View v) {
        if (!mIsRecording)
        {
            Log.i("toggle broadcasting", "toggle broadcasting");
            if (mLiveVideoBroadcaster != null) {
                Log.i("drig", "we have a broadcaster");
                if (!mLiveVideoBroadcaster.isConnected()) {
                    Log.i("drig", "we are connected");
                    String streamName = mStreamNameEditText.getText().toString();

                    Log.i("drig", "url="+(RTMP_BASE_URL + streamName));
                    ...
                    new AsyncTask<String, String, Boolean>() {
                        ...
                        protected Boolean doInBackground(String... url) {
                            Log.i("drig", "actually starting broadcasting at "+url[0]);
